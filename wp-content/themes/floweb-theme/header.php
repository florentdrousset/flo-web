...
<nav class="main-bg-color header-nav">
    <div class="max-v-lg flex justify-between align-text-bottom p-3 w-full lg:w-2/3 m-auto">
        ...
        <ul class="list-none montserrat flex flex-row none">
            <a href="/index.php/" class="nav-ele"><li class="none lg:block font-bold p-3 ml-3">Accueil</li></a>
            <a href="/index.php/blog" class="nav-ele"><li class="none lg:block font-bold p-3 ml-3">Blog</li></a>
            <a href="/index.php/services" class="nav-ele"><li class="none lg:block font-bold p-3 ml-3">Services</li></a>
            <a href="mailto:florent.drousset@gmail.com" class="nav-ele"><li class="none lg:block font-bold p-3 ml-3">Contact</li></a>
