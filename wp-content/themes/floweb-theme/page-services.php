    ...
    <div class="articles m-auto mt-8 w-1/2">
        <div>
            ...
            <div class="roboto mb-3">
                <p class="mb-2">Je m'appelle Florent, et je suis un développeur web fullstack spécialisé dans WordPress. Avant de me lancer en freelance, j'ai travaillé à plein temps en tant que développeur web back-end dans une ESN.
                ...
                <div class="bg-gray-100 dark:bg-gray-700">
                    <article class="flex mt-5 p-12 justify-between">
                        <div class="mr-3 flex-1">
                            ...
                            <h5 class="montserrat font-bold text-center">Solution clé en main</h5>
                        ...
                        <div class="flex-1">
                            ...
                            <h5 class="montserrat font-bold text-center">Code propre</h5>
                        ...
                        <div class="ml-3 flex-1"><img src="<?=BASE_FOLDER?>/assets/icons/smartphone.png" class="m-auto w-32"/>
                            <h5 class="montserrat font-bold text-center">Responsive</h5>
                    ...
                    <article class="flex p-12 justify-between">
                        <div class="mr-3 flex-1">
                            ...
                            <h5 class="montserrat font-bold text-center">A votre écoute</h5>
                        ...
                        <div class="flex-1"><img src="<?=BASE_FOLDER?>/assets/icons/objectif.png" class="m-auto w-32"/>
                            <h5 class="montserrat font-bold text-center">SEO & accessibilité</h5>
